...
#
# Date must be exactly YYYY-MM-DD, e.g. 2026-08-12.
# Any other spelling stops the site building.
title: Five CV mistakes that cost you the interview
date: 2026-08-12
description: Sample post — the one left in place at handover to copy from.
---

Body copy placeholder — this page is generated from a Markdown file Sarah commits on GitHub. Ordinary paragraphs render like this.
